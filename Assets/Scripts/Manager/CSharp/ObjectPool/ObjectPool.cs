...
namespace AKIRA.Manager {
    ...
    public class ObjectPool : Singleton<ObjectPool> {
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public T Instantiate<T>(string path, Vector3 position = default, Quaternion rotation = default) where T : Component, IPool {
        ...
        /// <param name="rotation"></param>
        /// <returns></returns>
        public GameObject Instantiate(GameObject target, Vector3 position = default, Quaternion rotation = default) {
